...
function openLinkCleaner() {
    window.open('https://linkcleaner.app/?url=' + encodeURIComponent(window.location.href), 'linkWindow', 'popup, width=400, height=500, left=100, top=100, noopener, noreferrer');
}
openLinkCleaner(); 